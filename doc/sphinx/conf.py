...
# -*- coding: utf-8 -*-
#
# SD1D documentation build configuration file, created by
...
if has_breathe:
    ...
    breathe_projects = { "sd1d": "../doxygen/sd1d/xml" }
    breathe_default_project = "sd1d"
...
project = 'SD1D'
copyright = '2017-2022'
author = 'The BOUT++ team and SD1D authors'
...
latex_documents = [
    (master_doc, 'sd1d.tex', 'SD1D Documentation',
...
man_pages = [
    (master_doc, 'sd1d', 'SD1D Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sd1d', 'SD1D Documentation',
     author, 'SD1D', 'One line description of project.',
     'Miscellaneous'),
]
